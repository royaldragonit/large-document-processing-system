using LargeDocumentProcessing.Domain.Constants;
...
public static class TestApp
{
    ...
    public static async Task<T> ExecuteAsync<T>(Func<IServiceProvider, Task<T>> action)
    {
        using var scope = FunctionalTestSetup.ScopeFactory.CreateScope();
        return await action(scope.ServiceProvider);
    }

    public static async Task ExecuteAsync(Func<IServiceProvider, Task> action)
    {
        using var scope = FunctionalTestSetup.ScopeFactory.CreateScope();
