...
namespace LargeDocumentProcessing.Web.Infrastructure;

/// <summary>
/// Adds standard error responses to every OpenAPI operation. A 400 Bad Request is added to all
/// operations for invalid input. 401 Unauthorized and 403 Forbidden are added only to operations that carry
